...
//        menuItems.add(new DishItem(4, "Биологический суп", 7.99, List.of("Шампиньоны", "Зеленые овощи", "Биологические добавки")));
//        menuItems.add(new DishItem(5, "Витаминный тартар", 11.99, List.of("Фрукты", "Ягоды", "Цитрусовый соус")));
//        menuItems.add(new DishItem(6, "Био-пудинг", 6.99, List.of("Биологические ингредиенты", "Сливки", "Фруктовый послевкусие")));
//        menuItems.add(new DishItem(7, "Свинина з терияки", 12.99, List.of("Свинина", "Соус терияки", "Овощной гарнир")));
//        menuItems.add(new DishItem(8, "Большой бургер Турбосвина", 13.99, List.of("Говядина", "Бекон", "Творог", "Овощи", "Специальный соус")));
//        menuItems.add(new DishItem(9, "Картофельные дольки по-свински", 9.99, List.of("Картофель", "Сало Турбосвин", "Соусы")));
//        menuItems.add(new DishItem(10, "Лечебный суп", 7.99, List.of("Овощи", "Куриной бульон", "Травы")));
//        menuItems.add(new DishItem(11, "Ориентальный салат с куриной грудкой", 10.99, List.of("Куриная грудка", "Восточные специи", "Салат", "Дрессинг")));
//        menuItems.add(new DishItem(12, "Медовый торт с лавандой", 8.99, List.of("Сливочная начинка", "Лепестки лаванды")));
